...
#include <X11/XF86keysym.h> /* allows for laptop special keys e.g. brightness to be used. */
...
static Key keys[] = {
	...
	{ 0,                            0x1008ff11, spawn,         SHCMD ("wpctl set-volume 46 0.05-")},
	{ 0,                            0x1008ff12, spawn,         SHCMD ("wpctl set-mute 46 toggle ")},
	{ 0,                            0x1008ff13, spawn,         SHCMD ("wpctl set-volume 46 0.05+")},
